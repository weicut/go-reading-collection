...
一切的程序只能串行发生。
![5-单进程操作系统.png](../images/GMP-model/af59f88f7368648fd0ff6c5878018503.png)
...
##### (2)多进程/线程时代有了调度器需求
![6-多进程操作系统.png](../images/GMP-model/0f81ebd436c9c0de69b4e1224b5df74f.png)
...
![7-cpu切换浪费成本.png](../images/GMP-model/7835f99097a4335851649313a47823e3.png)
...
![8-线程的内核和用户态.png](../images/GMP-model/7a92b6e7aaca56f013d6d1b617ea3311.png)

这样，我们再去细化去分类一下，内核线程依然叫“线程(thread)”，用户线程叫“协程(co-routine)".

![9-协程和线程.png](../images/GMP-model/701046e2437fc5048f251e44c898c76f.png)
...
![10-N-1关系.png](../images/GMP-model/a70dccd5a8baf06e2e6831c8deaa9bee.png)
...
![11-1-1.png](../images/GMP-model/b6d640bbfdcb10099646bd2b299af972.png)
...
![12-m-n.png](../images/GMP-model/caae67f991c146feb36afbd65474828f.png)
...
![13-gm.png](../images/GMP-model/e7462616b59c8c9ed9078430d560bdfa.png)

下面我们来看看被废弃的golang调度器是如何实现的？

![14-old调度器.png](../images/GMP-model/d207e1db28eba279295c5e3fe4d7d242.png)
...
![15-gmp.png](../images/GMP-model/69b87943d5422c59fc9b32aeee2a1b5c.png)
...
![16-GMP-调度.png](../images/GMP-model/e1d14ddbe3e7a75b023b6f30344f8d20.jpeg)
...
![18-go-func调度周期.jpeg](../images/GMP-model/8126e9d2d04d8baae12a232e0466cb4b.jpeg)
...
![17-pic-go调度器生命周期.png](../images/GMP-model/71e2684a37f686e890f07b8f4db28838.png)
...
![19-go-trace1.png](../images/GMP-model/c877d8ee3873239b270eb1eb85d33485.png)

![20-go-trace2.png](../images/GMP-model/6e0aba4307dab801ecf322d265ef9a36.png)

**G信息**

点击Goroutines那一行可视化的数据条，我们会看到一些详细的信息。

![20-go-trace3.png](../images/GMP-model/392e0115f37f6a5bd3a408de5cd6f637.png)
...
![22-go-trace4.png](../images/GMP-model/5fc209023d52e5bd4236e88ec0ea31ac.png)

一共有两个M在程序中，一个是特殊的M0，用于初始化使用，这个我们不必讨论。

**P信息**
![23-go-trace5.png](../images/GMP-model/be9bdbdd1ede381319bc908fa00b01bf.png)
...
![24-go-trace6.png](../images/GMP-model/1b2030b5dc7edae805972d96f38f2452.png)

我们会发现，确实G18在P0上被运行的时候，确实在Threads行多了一个M的数据，点击查看如下：

![25-go-trace7.png](../images/GMP-model/e8e6d876537b651dd3ec945dccd44812.png)
...
![26-gmp场景1.png](../images/GMP-model/dc93be2f43854fcb9e55f305cf183682.png)
...
![27-gmp场景2.png](../images/GMP-model/8275808864f452508a16bbab81b4d99e.png)
...
![28-gmp场景3.png](../images/GMP-model/f50e764039498b83d468ce073f63a633.png)
...
![29-gmp场景4.png](../images/GMP-model/ae511acefa597c40d01dcdc1e4ee78ac.png)
...
![30-gmp场景5.png](../images/GMP-model/c02495eae39e1940af8d9d1df170047b.png)
...
![31-gmp场景6.png](../images/GMP-model/c4bac8c1b7e7e7b29d855f39c97af4da.png)
...
![32-gmp场景7.001.jpeg](../images/GMP-model/fe7952a003e4a0355f51294ad4af15f0.jpeg)
...
![33-gmp场景8.png](../images/GMP-model/de96eef8e910da334941c3332796ac97.png)
...
![34-gmp场景9.png](../images/GMP-model/f3d43b818f794677312e21395bc11658.png)
...
![35-gmp场景10.png](../images/GMP-model/1d41b5b4f46fff6f83db271baeaecf3d.png)


##### (11)场景11

G8创建了G9，假如G8进行了**非阻塞系统调用**。
![36-gmp场景11.png](../images/GMP-model/13abfea5fa456b0541bd4ab72d04992f.png)
...
> 作者：Aceld(刘丹冰)
> 链接：https://learnku.com/articles/41728
> 来源：learnku
